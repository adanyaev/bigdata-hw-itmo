...
from pyflink.datastream.window import TumblingEventTimeWindows, TumblingProcessingTimeWindows, Time, TimeWindow
...
def python_data_stream_example():
    ...
    windowed_stream = ds.key_by(lambda x: x[0]).window(TumblingProcessingTimeWindows.of(Time.seconds(30)))
