...
from pyflink.datastream.window import SlidingProcessingTimeWindows, SlidingEventTimeWindows, Time, TimeWindow
...
def python_data_stream_example():
    ...
    sink = KafkaSink.builder() \
        ...
        .set_record_serializer(KafkaRecordSerializationSchema.builder()
                               .set_topic('itmo2023_processed_SlidingWindow')
    ...
    windowed_stream = ds.key_by(lambda x: x[0]).window(SlidingProcessingTimeWindows.of(Time.seconds(30), Time.seconds(10)))
    windowed_stream.apply(MyWindowFunction(), Types.STRING()).sink_to(sink)
    env.execute_async("Devices preprocessing2")
